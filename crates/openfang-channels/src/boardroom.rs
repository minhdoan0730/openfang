//! Boardroom system for multi‑agent Discord collaboration.
//!
//! Manages persistent boardroom threads where multiple agents can collaborate,
//! with turn policies, circuit breakers, and idle timeout cleanup.
...
impl BoardroomRegistry {
    ...
    pub async fn new(config: BoardroomConfig, memory: MemorySubstrate) -> OpenFangResult<Self> {
